...
$read = $db->prepare('SELECT * FROM actuality WHERE id = :id');
$read->execute([
    ':id' => $_GET['id']
]);
$modif = $read->fetch();
...
<html lang="fr">
    ...
    <body>
        <section class="addBack">
            ...
            <div class="formAdd">
                <h1 class="title"><div class="cercle"></div>Modifier une actualité</h1>
                <div>
                    <form method="POST" action="core/updateActu.php" enctype="multipart/form-data">
                        <p>
                        ...
                        <p>
                            <textarea type="text" name="description" placeholder="Description de l'actualité" required><?= $modif['description'] ?></textarea>
                        </p>
                        <p>
