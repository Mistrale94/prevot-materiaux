...
<html lang="fr">
    ...
    <body>
        <section class="addBack">
            ...
            <div class="formAdd">
                <h1 class="title"><div class="cercle"></div>Ajouter une actulité</h1>
                <div>
                    <form method="POST" action="core/addActu.php" enctype="multipart/form-data">
                        ...
                        <p>
                            <textarea type="text" name="description" placeholder="Description de l'actualité" required></textarea>
                        </p>
                        <p>
