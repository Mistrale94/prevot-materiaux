...
<html lang="fr">
    ...
    <body>
        <section class="addBack">
            ...
            <div class="formAdd">
                <h1 class="title"><div class="cercle"></div>Modifier un chantier</h1>
                <div>
                    <form method="POST" action="core/updateChantier.php" enctype="multipart/form-data">
                        <p>
                        ...
                        <p>
                            <input type="text" name="title" placeholder="Le titre du chantier" value="<?= $modif['title'] ?>" required>
                        </p>
                        <p>
                            <input type="date" name="date" class="date" value="<?= $modif['date'] ?>">
                        </p>
                        <p>
                            <textarea type="text" name="description" placeholder="Description du chantier" required><?= $modif['description'] ?></textarea>
                        </p>
                        <p>
