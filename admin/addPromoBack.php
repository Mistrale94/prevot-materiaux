...
<html lang="fr">
    ...
    <body>
        <section class="addBack">
            ...
            <div class="formAdd">
                <h1 class="title"><div class="cercle"></div>Ajouter une promotion</h1>
                <div>
                    <form method="POST" action="core/addPromo.php" enctype="multipart/form-data">
                        <p class="addFile">
                        ...
                        <p>
                            <input type="text" name="title" placeholder="Le titre de la promotion" required>
                        </p>
                        <p>
                            <input type="date" name="date" class="date" required>
                        </p>
                        <p>
                            <textarea name="description" placeholder="Description de l'actualité" required></textarea>
                        </p>
                        <p>
